...
At a glance: roughly 16x smaller feature vectors, comparable accuracy to raw fingerprints, and a drop-in fit for any scikit-learn model. If you just want to try it, jump to [Quick Start](#quick-start); if you want the reasoning first, read [Why Use Embedded Fingerprints?](#why-use-embedded-fingerprints) below.
